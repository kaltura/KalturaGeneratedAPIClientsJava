...
public class KalturaThumbParamsOutputService extends KalturaServiceBase {
    ...
    public KalturaThumbParamsOutput get(int id) throws KalturaApiException {
        ...
        kparams.add("id", id);
        this.kalturaClient.queueServiceCall("thumbparamsoutput", "get", kparams, KalturaThumbParamsOutput.class);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaThumbParamsOutput.class, resultXmlElement);
    }
    ...
    public KalturaThumbParamsOutputListResponse list(KalturaThumbParamsOutputFilter filter) throws KalturaApiException {
    ...
    public KalturaThumbParamsOutputListResponse list(KalturaThumbParamsOutputFilter filter, KalturaFilterPager pager) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("thumbparamsoutput", "list", kparams, KalturaThumbParamsOutputListResponse.class);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaThumbParamsOutputListResponse.class, resultXmlElement);
    }
}
