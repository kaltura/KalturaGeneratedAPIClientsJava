...
public class KalturaFlavorParamsOutputService extends KalturaServiceBase {
    ...
    public KalturaFlavorParamsOutput get(int id) throws KalturaApiException {
        ...
        kparams.add("id", id);
        this.kalturaClient.queueServiceCall("flavorparamsoutput", "get", kparams, KalturaFlavorParamsOutput.class);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaFlavorParamsOutput.class, resultXmlElement);
    }
    ...
    public KalturaFlavorParamsOutputListResponse list(KalturaFlavorParamsOutputFilter filter, KalturaFilterPager pager) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("flavorparamsoutput", "list", kparams, KalturaFlavorParamsOutputListResponse.class);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaFlavorParamsOutputListResponse.class, resultXmlElement);
    }
}
