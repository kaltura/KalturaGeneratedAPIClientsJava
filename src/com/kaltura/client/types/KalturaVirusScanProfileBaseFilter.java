...
public abstract class KalturaVirusScanProfileBaseFilter extends KalturaFilter {
    ...
    public KalturaVirusScanProfileBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = KalturaVirusScanProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("statusIn")) {
                this.statusIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("engineTypeEqual")) {
                this.engineTypeEqual = KalturaVirusScanEngineType.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("engineTypeIn")) {
                this.engineTypeIn = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
