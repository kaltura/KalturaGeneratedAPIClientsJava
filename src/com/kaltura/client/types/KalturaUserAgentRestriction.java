...
import com.kaltura.client.enums.KalturaUserAgentRestrictionType;
...
public class KalturaUserAgentRestriction extends KalturaBaseRestriction {
    ...
    public KalturaUserAgentRestriction(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("userAgentRestrictionType")) {
                this.userAgentRestrictionType = KalturaUserAgentRestrictionType.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("userAgentRegexList")) {
                this.userAgentRegexList = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
