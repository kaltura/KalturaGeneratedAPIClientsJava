...
public class KalturaQuestionCuePoint extends KalturaCuePoint {
    ...
    public KalturaQuestionCuePoint(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("optionalAnswers")) {
                this.optionalAnswers = ParseUtils.parseMap(KalturaOptionalAnswer.class, aNode);
                continue;
            } else if (nodeName.equals("hint")) {
                this.hint = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("question")) {
                this.question = ParseUtils.parseString(txt);
                continue;
