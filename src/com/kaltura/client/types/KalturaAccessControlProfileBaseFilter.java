...
public abstract class KalturaAccessControlProfileBaseFilter extends KalturaRelatedFilter {
    ...
    public KalturaAccessControlProfileBaseFilter() {
    }

    public KalturaAccessControlProfileBaseFilter(Element node) throws KalturaApiException {
        super(node);
