...
import com.kaltura.client.enums.KalturaScheduledTaskAddOrRemoveType;
...
public class KalturaModifyCategoriesObjectTask extends KalturaObjectTask {
    ...
    public KalturaModifyCategoriesObjectTask(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("addRemoveType")) {
                this.addRemoveType = KalturaScheduledTaskAddOrRemoveType.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("categoryIds")) {
                this.categoryIds = ParseUtils.parseArray(KalturaIntegerValue.class, aNode);
                continue;
            } 
        }
    }
