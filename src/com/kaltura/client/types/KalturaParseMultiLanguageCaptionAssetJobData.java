...
public class KalturaParseMultiLanguageCaptionAssetJobData extends KalturaJobData {
    ...
    public KalturaParseMultiLanguageCaptionAssetJobData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("multiLanaguageCaptionAssetId")) {
                this.multiLanaguageCaptionAssetId = ParseUtils.parseString(txt);
                continue;
