...
public class KalturaSshUrlResource extends KalturaUrlResource {
    ...
    public KalturaSshUrlResource(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("privateKey")) {
                ...
                continue;
            } else if (nodeName.equals("keyPassphrase")) {
                this.keyPassphrase = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
