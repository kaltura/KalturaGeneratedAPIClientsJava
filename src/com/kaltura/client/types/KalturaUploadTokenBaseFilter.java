...
public abstract class KalturaUploadTokenBaseFilter extends KalturaFilter {
    ...
    public double fileSizeEqual = Double.MIN_VALUE;
    ...
    public KalturaUploadTokenBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = KalturaUploadTokenStatus.get(ParseUtils.parseInt(txt));
                continue;
                ...
                continue;
            } else if (nodeName.equals("fileSizeEqual")) {
                this.fileSizeEqual = ParseUtils.parseDouble(txt);
                continue;
            } 
        }
    }
