...
public class KalturaMediaServer extends KalturaObjectBase {
	/**  Unique identifier     */
    ...
    public KalturaMediaServer() {
    }

    public KalturaMediaServer(Element node) throws KalturaApiException {
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaMediaServer");
        return kparams;
    }
