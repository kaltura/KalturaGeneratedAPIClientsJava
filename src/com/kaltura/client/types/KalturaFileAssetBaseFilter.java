...
public abstract class KalturaFileAssetBaseFilter extends KalturaRelatedFilter {
    ...
    public KalturaFileAssetBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                continue;
            } else if (nodeName.equals("fileAssetObjectTypeEqual")) {
                this.fileAssetObjectTypeEqual = KalturaFileAssetObjectType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.statusEqual = KalturaFileAssetStatus.get(ParseUtils.parseString(txt));
                continue;
