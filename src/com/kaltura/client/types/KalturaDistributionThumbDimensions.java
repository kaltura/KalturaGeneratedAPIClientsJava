...
public class KalturaDistributionThumbDimensions extends KalturaObjectBase {
    ...
    public KalturaDistributionThumbDimensions(Element node) throws KalturaApiException {
