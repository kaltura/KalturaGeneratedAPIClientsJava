...
public class KalturaRemoteStorageResources extends KalturaContentResource {
    ...
    public KalturaRemoteStorageResources(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("resources")) {
                this.resources = ParseUtils.parseArray(KalturaRemoteStorageResource.class, aNode);
                continue;
            } 
        }
    }
