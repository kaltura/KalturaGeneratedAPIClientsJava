...
public abstract class KalturaLiveChannelSegmentBaseFilter extends KalturaRelatedFilter {
    ...
    public KalturaLiveChannelSegmentBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("createdAtGreaterThanOrEqual")) {
                ...
                this.statusEqual = KalturaLiveChannelSegmentStatus.get(ParseUtils.parseString(txt));
                continue;
