...
public class KalturaEventNotificationArrayParameter extends KalturaEventNotificationParameter {
    ...
    public KalturaEventNotificationArrayParameter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("values")) {
                this.values = ParseUtils.parseArray(KalturaString.class, aNode);
                continue;
            } else if (nodeName.equals("allowedValues")) {
                this.allowedValues = ParseUtils.parseArray(KalturaStringValue.class, aNode);
                continue;
            } 
        }
    }
