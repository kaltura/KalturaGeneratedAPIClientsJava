...
public abstract class KalturaDetachedResponseProfileFilter extends KalturaFilter {
    ...
    public KalturaDetachedResponseProfileFilter() {
    }

    public KalturaDetachedResponseProfileFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = KalturaResponseProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaDetachedResponseProfileFilter");
