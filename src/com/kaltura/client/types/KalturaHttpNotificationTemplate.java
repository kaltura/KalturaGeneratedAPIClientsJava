...
public class KalturaHttpNotificationTemplate extends KalturaEventNotificationTemplate {
    ...
    public KalturaHttpNotificationTemplate(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("url")) {
                ...
                this.data = ParseUtils.parseObject(KalturaHttpNotificationData.class, aNode);
                continue;
