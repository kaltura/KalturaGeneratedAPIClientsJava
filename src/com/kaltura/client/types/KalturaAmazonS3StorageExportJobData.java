...
public class KalturaAmazonS3StorageExportJobData extends KalturaStorageExportJobData {
    ...
    public KalturaAmazonS3StorageExportJobData(Element node) throws KalturaApiException {
        super(node);
