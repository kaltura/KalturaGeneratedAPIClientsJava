...
public class KalturaExternalMediaEntry extends KalturaMediaEntry {
    ...
    public KalturaExternalMediaEntry(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("externalSourceType")) {
                this.externalSourceType = KalturaExternalMediaSourceType.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("assetParamsIds")) {
                this.assetParamsIds = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
