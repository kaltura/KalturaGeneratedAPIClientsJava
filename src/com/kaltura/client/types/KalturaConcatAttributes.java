...
public class KalturaConcatAttributes extends KalturaOperationAttributes {
    ...
    public KalturaConcatAttributes(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("resource")) {
                this.resource = ParseUtils.parseObject(KalturaDataCenterContentResource.class, aNode);
                continue;
            } 
        }
    }
