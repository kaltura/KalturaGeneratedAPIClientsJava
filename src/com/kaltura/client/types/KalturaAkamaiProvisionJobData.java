...
public class KalturaAkamaiProvisionJobData extends KalturaProvisionJobData {
    ...
    public KalturaAkamaiProvisionJobData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("wsdlUsername")) {
                this.wsdlUsername = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("wsdlPassword")) {
                this.wsdlPassword = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("cpcode")) {
                this.cpcode = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("emailId")) {
                this.emailId = ParseUtils.parseString(txt);
                continue;
