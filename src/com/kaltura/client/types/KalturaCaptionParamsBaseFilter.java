...
public abstract class KalturaCaptionParamsBaseFilter extends KalturaAssetParamsFilter {
    ...
    public KalturaCaptionParamsBaseFilter(Element node) throws KalturaApiException {
        super(node);
