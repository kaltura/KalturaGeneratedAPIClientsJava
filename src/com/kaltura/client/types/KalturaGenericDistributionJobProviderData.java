...
public class KalturaGenericDistributionJobProviderData extends KalturaDistributionJobProviderData {
    public String xml;
    ...
    public KalturaGenericDistributionJobProviderData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("xml")) {
                ...
                continue;
            } else if (nodeName.equals("resultParseData")) {
                this.resultParseData = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("resultParserType")) {
                this.resultParserType = KalturaGenericDistributionProviderParser.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
