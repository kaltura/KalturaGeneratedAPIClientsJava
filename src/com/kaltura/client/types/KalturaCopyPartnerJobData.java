...
public class KalturaCopyPartnerJobData extends KalturaJobData {
    ...
    public KalturaCopyPartnerJobData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("fromPartnerId")) {
                this.fromPartnerId = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("toPartnerId")) {
                this.toPartnerId = ParseUtils.parseInt(txt);
                continue;
            } 
        }
    }
