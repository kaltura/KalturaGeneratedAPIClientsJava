...
public class KalturaMatchMetadataCondition extends KalturaMatchCondition {
    ...
    public KalturaMatchMetadataCondition() {
    }

    public KalturaMatchMetadataCondition(Element node) throws KalturaApiException {
        super(node);
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaMatchMetadataCondition");
