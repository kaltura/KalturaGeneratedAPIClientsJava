...
public class KalturaConvertEntryFlavorsObjectTask extends KalturaObjectTask {
    ...
    public KalturaConvertEntryFlavorsObjectTask(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("flavorParamsIds")) {
                ...
                continue;
            } else if (nodeName.equals("reconvert")) {
                this.reconvert = ParseUtils.parseBool(txt);
                continue;
            } 
        }
    }
