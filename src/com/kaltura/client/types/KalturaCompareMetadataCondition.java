...
public class KalturaCompareMetadataCondition extends KalturaCompareCondition {
    ...
    public KalturaCompareMetadataCondition(Element node) throws KalturaApiException {
        super(node);
