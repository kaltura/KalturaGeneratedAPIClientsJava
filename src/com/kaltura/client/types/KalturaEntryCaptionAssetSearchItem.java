...
public class KalturaEntryCaptionAssetSearchItem extends KalturaSearchItem {
    ...
    public KalturaEntryCaptionAssetSearchItem(Element node) throws KalturaApiException {
        super(node);
