...
import com.kaltura.client.enums.KalturaLimitFlavorsRestrictionType;
...
public class KalturaLimitFlavorsRestriction extends KalturaBaseRestriction {
    ...
    public KalturaLimitFlavorsRestriction(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("limitFlavorsRestrictionType")) {
                this.limitFlavorsRestrictionType = KalturaLimitFlavorsRestrictionType.get(ParseUtils.parseInt(txt));
                continue;
