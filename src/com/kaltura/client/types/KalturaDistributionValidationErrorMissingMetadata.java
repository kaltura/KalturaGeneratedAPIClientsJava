...
public class KalturaDistributionValidationErrorMissingMetadata extends KalturaDistributionValidationError {
    public String fieldName;

    public KalturaDistributionValidationErrorMissingMetadata() {
    }

    public KalturaDistributionValidationErrorMissingMetadata(Element node) throws KalturaApiException {
        super(node);
