...
public abstract class KalturaMediaServerBaseFilter extends KalturaFilter {
    ...
    public KalturaMediaServerBaseFilter() {
    }

    public KalturaMediaServerBaseFilter(Element node) throws KalturaApiException {
        super(node);
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("objectType", "KalturaMediaServerBaseFilter");
