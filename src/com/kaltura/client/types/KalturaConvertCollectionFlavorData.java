...
public class KalturaConvertCollectionFlavorData extends KalturaObjectBase {
    ...
    public KalturaConvertCollectionFlavorData(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("flavorAssetId")) {
                ...
                continue;
            } else if (nodeName.equals("destFileSyncLocalPath")) {
