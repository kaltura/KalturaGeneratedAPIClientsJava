...
public class KalturaEventNotificationDispatchJobData extends KalturaJobData {
    ...
    public KalturaEventNotificationDispatchJobData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("templateId")) {
                ...
                this.contentParameters = ParseUtils.parseArray(KalturaKeyValue.class, aNode);
                continue;
            } 
        }
    }
