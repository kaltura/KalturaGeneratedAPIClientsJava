    ...
    public KalturaThumbParamsOutputBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("thumbParamsIdEqual")) {
                ...
                this.thumbParamsVersionEqual = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("thumbAssetIdEqual")) {
                this.thumbAssetIdEqual = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("thumbAssetVersionEqual")) {
                this.thumbAssetVersionEqual = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
