...
public abstract class KalturaCategoryEntryBaseFilter extends KalturaRelatedFilter {
    ...
    public KalturaCategoryEntryBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("categoryIdEqual")) {
                ...
                this.statusEqual = KalturaCategoryEntryStatus.get(ParseUtils.parseInt(txt));
                continue;
