...
public class KalturaLiveParams extends KalturaFlavorParams {
    ...
    public KalturaLiveParams() {
    }

    public KalturaLiveParams(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("streamSuffix")) {
                this.streamSuffix = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
