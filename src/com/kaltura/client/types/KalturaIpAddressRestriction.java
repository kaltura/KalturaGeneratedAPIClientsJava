...
public class KalturaIpAddressRestriction extends KalturaBaseRestriction {
    ...
    public KalturaIpAddressRestriction(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("ipAddressRestrictionType")) {
                this.ipAddressRestrictionType = KalturaIpAddressRestrictionType.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("ipAddressList")) {
                this.ipAddressList = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
