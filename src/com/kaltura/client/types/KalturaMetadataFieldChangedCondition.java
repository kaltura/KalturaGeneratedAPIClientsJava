...
public class KalturaMetadataFieldChangedCondition extends KalturaMatchCondition {
    ...
    public KalturaMetadataFieldChangedCondition(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("xPath")) {
                ...
                continue;
            } else if (nodeName.equals("versionA")) {
                this.versionA = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("versionB")) {
                this.versionB = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
