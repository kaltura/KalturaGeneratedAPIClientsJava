...
import com.kaltura.client.enums.KalturaDeleteFlavorsLogicType;
...
public class KalturaDeleteEntryFlavorsObjectTask extends KalturaObjectTask {
    ...
    public KalturaDeleteEntryFlavorsObjectTask(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("deleteType")) {
                this.deleteType = KalturaDeleteFlavorsLogicType.get(ParseUtils.parseInt(txt));
                continue;
