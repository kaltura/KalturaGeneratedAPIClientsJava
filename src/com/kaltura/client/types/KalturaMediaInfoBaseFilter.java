...
public abstract class KalturaMediaInfoBaseFilter extends KalturaFilter {
    public String flavorAssetIdEqual;

    public KalturaMediaInfoBaseFilter() {
    }

    public KalturaMediaInfoBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("flavorAssetIdEqual")) {
