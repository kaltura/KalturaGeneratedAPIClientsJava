...
public class KalturaUrlRecognizer extends KalturaObjectBase {
    ...
    public KalturaUrlRecognizer(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("hosts")) {
                this.hosts = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("uriPrefix")) {
                this.uriPrefix = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
