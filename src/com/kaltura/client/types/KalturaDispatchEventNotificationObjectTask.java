...
public class KalturaDispatchEventNotificationObjectTask extends KalturaObjectTask {
    ...
    public KalturaDispatchEventNotificationObjectTask(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("eventNotificationTemplateId")) {
                this.eventNotificationTemplateId = ParseUtils.parseInt(txt);
                continue;
            } 
        }
    }
