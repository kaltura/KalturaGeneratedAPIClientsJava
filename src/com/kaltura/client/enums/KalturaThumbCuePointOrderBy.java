 ...
 */
public enum KalturaThumbCuePointOrderBy implements KalturaEnumAsString {
    ...
    KalturaThumbCuePointOrderBy(String hashCode) {
    ...
    public static KalturaThumbCuePointOrderBy get(String hashCode) {
