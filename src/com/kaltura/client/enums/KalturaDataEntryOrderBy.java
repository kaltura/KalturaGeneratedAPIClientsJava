 ...
 */
public enum KalturaDataEntryOrderBy implements KalturaEnumAsString {
    ...
    KalturaDataEntryOrderBy(String hashCode) {
    ...
    public static KalturaDataEntryOrderBy get(String hashCode) {
