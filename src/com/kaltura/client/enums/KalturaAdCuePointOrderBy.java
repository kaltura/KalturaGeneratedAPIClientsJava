 ...
 */
public enum KalturaAdCuePointOrderBy implements KalturaEnumAsString {
    ...
    KalturaAdCuePointOrderBy(String hashCode) {
    ...
    public static KalturaAdCuePointOrderBy get(String hashCode) {
