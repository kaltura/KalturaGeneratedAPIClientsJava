 ...
 */
public enum KalturaLiveStreamAdminEntryOrderBy implements KalturaEnumAsString {
    ...
    KalturaLiveStreamAdminEntryOrderBy(String hashCode) {
    ...
    public static KalturaLiveStreamAdminEntryOrderBy get(String hashCode) {
