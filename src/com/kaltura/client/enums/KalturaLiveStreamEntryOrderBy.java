 ...
 */
public enum KalturaLiveStreamEntryOrderBy implements KalturaEnumAsString {
    ...
    KalturaLiveStreamEntryOrderBy(String hashCode) {
    ...
    public static KalturaLiveStreamEntryOrderBy get(String hashCode) {
