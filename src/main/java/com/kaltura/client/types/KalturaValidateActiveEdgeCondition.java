...
public class KalturaValidateActiveEdgeCondition extends KalturaCondition {
    ...
    public KalturaValidateActiveEdgeCondition(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("edgeServerIds")) {
                this.edgeServerIds = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
