...
public class KalturaDistributionValidationErrorInvalidMetadata extends KalturaDistributionValidationErrorInvalidData {
    public int metadataProfileId = Integer.MIN_VALUE;

    public KalturaDistributionValidationErrorInvalidMetadata() {
    }

    public KalturaDistributionValidationErrorInvalidMetadata(Element node) throws KalturaApiException {
        super(node);
