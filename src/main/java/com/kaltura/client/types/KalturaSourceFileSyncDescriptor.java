...
public class KalturaSourceFileSyncDescriptor extends KalturaFileSyncDescriptor {
    ...
    public KalturaSourceFileSyncDescriptor(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("actualFileSyncLocalPath")) {
                this.actualFileSyncLocalPath = ParseUtils.parseString(txt);
                continue;
