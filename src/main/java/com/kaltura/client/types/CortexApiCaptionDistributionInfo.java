...
import com.kaltura.client.enums.CortexApiDistributionCaptionAction;
...
@MultiRequestBuilder.Tokenizer(CortexApiCaptionDistributionInfo.Tokenizer.class)
public class CortexApiCaptionDistributionInfo extends ObjectBase {
	...
	private CortexApiDistributionCaptionAction action;
	...
	// action:
	public CortexApiDistributionCaptionAction getAction(){
		return this.action;
	}
	public void setAction(CortexApiDistributionCaptionAction action){
		this.action = action;
	}
	...
	public CortexApiCaptionDistributionInfo() {
		super();
	}

	public CortexApiCaptionDistributionInfo(JsonObject jsonObject) throws APIException {
		super(jsonObject);
		...
		action = CortexApiDistributionCaptionAction.get(GsonParser.parseInt(jsonObject.get("action")));
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaCortexApiCaptionDistributionInfo");
