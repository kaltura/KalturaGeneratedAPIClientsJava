...
@MultiRequestBuilder.Tokenizer(ESearchGroupResult.Tokenizer.class)
public class ESearchGroupResult extends ESearchResult {
	...
	public ESearchGroupResult(JsonObject jsonObject) throws APIException {
		super(jsonObject);

		if(jsonObject == null) return;

		// set members values:
		object = GsonParser.parseObject(jsonObject.getAsJsonObject("object"), Group.class);

	}

	public Params toParams() {
		Params kparams = super.toParams();
		kparams.add("objectType", "KalturaESearchGroupResult");
