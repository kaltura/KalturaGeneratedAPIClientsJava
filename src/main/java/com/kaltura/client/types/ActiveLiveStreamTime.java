...
@MultiRequestBuilder.Tokenizer(ActiveLiveStreamTime.Tokenizer.class)
public class ActiveLiveStreamTime extends ObjectBase {
	...
	public ActiveLiveStreamTime(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaActiveLiveStreamTime");
