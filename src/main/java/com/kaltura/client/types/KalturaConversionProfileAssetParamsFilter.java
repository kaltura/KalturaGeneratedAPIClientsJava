...
public class KalturaConversionProfileAssetParamsFilter extends KalturaConversionProfileAssetParamsBaseFilter {
    ...
    public KalturaConversionProfileAssetParamsFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("conversionProfileIdFilter")) {
                this.conversionProfileIdFilter = ParseUtils.parseObject(KalturaConversionProfileFilter.class, aNode);
                continue;
            } else if (nodeName.equals("assetParamsIdFilter")) {
                this.assetParamsIdFilter = ParseUtils.parseObject(KalturaAssetParamsFilter.class, aNode);
                continue;
            } 
        }
    }
