...
public class KalturaAssetsParamsResourceContainers extends KalturaResource {
    ...
    public KalturaAssetsParamsResourceContainers(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("resources")) {
                this.resources = ParseUtils.parseArray(KalturaAssetParamsResourceContainer.class, aNode);
                continue;
            } 
        }
    }
