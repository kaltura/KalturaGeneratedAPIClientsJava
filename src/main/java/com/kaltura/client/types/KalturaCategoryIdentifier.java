...
import com.kaltura.client.enums.KalturaCategoryIdentifierField;
...
public class KalturaCategoryIdentifier extends KalturaObjectIdentifier {
    ...
    public KalturaCategoryIdentifier(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("identifier")) {
                this.identifier = KalturaCategoryIdentifierField.get(ParseUtils.parseString(txt));
                continue;
            } 
        }
    }
