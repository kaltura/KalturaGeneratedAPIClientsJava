...
public class KalturaEntryContext extends KalturaContext {
    ...
    public KalturaEntryContext(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("entryId")) {
                ...
                continue;
            } else if (nodeName.equals("followEntryRedirect")) {
                this.followEntryRedirect = KalturaNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
