...
public class KalturaFacebookDistributionJobProviderData extends KalturaConfigurableDistributionJobProviderData {
    public String videoAssetFilePath;
    public String thumbAssetFilePath;
    public ArrayList<KalturaFacebookCaptionDistributionInfo> captionsInfo;

    public KalturaFacebookDistributionJobProviderData() {
    }

    public KalturaFacebookDistributionJobProviderData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("videoAssetFilePath")) {
                ...
                this.captionsInfo = ParseUtils.parseArray(KalturaFacebookCaptionDistributionInfo.class, aNode);
                continue;
            } 
        }
    }
