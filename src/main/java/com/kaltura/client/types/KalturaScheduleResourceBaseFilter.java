...
import com.kaltura.client.enums.KalturaScheduleResourceStatus;
...
public abstract class KalturaScheduleResourceBaseFilter extends KalturaRelatedFilter {
    ...
    public KalturaScheduleResourceBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = KalturaScheduleResourceStatus.get(ParseUtils.parseInt(txt));
                continue;
