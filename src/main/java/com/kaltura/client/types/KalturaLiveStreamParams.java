...
public class KalturaLiveStreamParams extends KalturaObjectBase {
    ...
    public KalturaLiveStreamParams(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("bitrate")) {
                ...
                continue;
            } else if (nodeName.equals("flavorId")) {
                this.flavorId = ParseUtils.parseString(txt);
                continue;
                ...
                this.codec = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
