...
@MultiRequestBuilder.Tokenizer(ESearchCategoryMetadataItem.Tokenizer.class)
public class ESearchCategoryMetadataItem extends ESearchAbstractCategoryItem {
	...
	public ESearchCategoryMetadataItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaESearchCategoryMetadataItem");
