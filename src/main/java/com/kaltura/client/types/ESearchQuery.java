...
public class ESearchQuery extends ESearchObject {
	...
	private String eSerachQuery;

	// eSerachQuery:
	public String getESerachQuery(){
		return this.eSerachQuery;
	}
	public void setESerachQuery(String eSerachQuery){
		this.eSerachQuery = eSerachQuery;
	}

	public void eSerachQuery(String multirequestToken){
		setToken("eSerachQuery", multirequestToken);
	}
	...
	public ESearchQuery(JsonObject jsonObject) throws APIException {
		...
		// set members values:
		eSerachQuery = GsonParser.parseString(jsonObject.get("eSerachQuery"));
	...
	public Params toParams() {
		...
		kparams.add("eSerachQuery", this.eSerachQuery);
		return kparams;
	}
