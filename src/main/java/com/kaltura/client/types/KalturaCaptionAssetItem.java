...
public class KalturaCaptionAssetItem extends KalturaObjectBase {
    ...
    public KalturaCaptionAssetItem(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("asset")) {
                this.asset = ParseUtils.parseObject(KalturaCaptionAsset.class, aNode);
                continue;
            } else if (nodeName.equals("entry")) {
                this.entry = ParseUtils.parseObject(KalturaBaseEntry.class, aNode);
                continue;
