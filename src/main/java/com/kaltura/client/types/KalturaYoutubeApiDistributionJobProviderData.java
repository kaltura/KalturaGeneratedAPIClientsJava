...
public class KalturaYoutubeApiDistributionJobProviderData extends KalturaConfigurableDistributionJobProviderData {
    public String videoAssetFilePath;
    public String thumbAssetFilePath;
    public ArrayList<KalturaYouTubeApiCaptionDistributionInfo> captionsInfo;

    public KalturaYoutubeApiDistributionJobProviderData() {
    }

    public KalturaYoutubeApiDistributionJobProviderData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("videoAssetFilePath")) {
                ...
                this.captionsInfo = ParseUtils.parseArray(KalturaYouTubeApiCaptionDistributionInfo.class, aNode);
                continue;
            } 
        }
    }
