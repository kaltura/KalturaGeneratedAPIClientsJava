...
@MultiRequestBuilder.Tokenizer(ESearchAbstractGroupItem.Tokenizer.class)
public abstract class ESearchAbstractGroupItem extends ESearchGroupBaseItem {
	...
	public ESearchAbstractGroupItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaESearchAbstractGroupItem");
