...
@MultiRequestBuilder.Tokenizer(ESearchUserMetadataItem.Tokenizer.class)
public class ESearchUserMetadataItem extends ESearchAbstractUserItem {
	...
	public ESearchUserMetadataItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaESearchUserMetadataItem");
