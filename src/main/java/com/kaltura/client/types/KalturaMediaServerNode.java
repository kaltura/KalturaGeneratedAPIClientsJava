...
public abstract class KalturaMediaServerNode extends KalturaDeliveryServerNode {
    ...
    public KalturaMediaServerNode(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("applicationName")) {
                this.applicationName = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("mediaServerPortConfig")) {
                this.mediaServerPortConfig = ParseUtils.parseArray(KalturaKeyValue.class, aNode);
                continue;
            } else if (nodeName.equals("mediaServerPlaybackDomainConfig")) {
                this.mediaServerPlaybackDomainConfig = ParseUtils.parseArray(KalturaKeyValue.class, aNode);
                continue;
            } 
        }
    }
