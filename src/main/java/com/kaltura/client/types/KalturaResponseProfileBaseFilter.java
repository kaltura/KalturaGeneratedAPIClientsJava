...
public abstract class KalturaResponseProfileBaseFilter extends KalturaFilter {
    ...
    public KalturaResponseProfileBaseFilter(Element node) throws KalturaApiException {
        super(node);
