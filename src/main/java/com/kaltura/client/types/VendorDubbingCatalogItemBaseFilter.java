...
@MultiRequestBuilder.Tokenizer(VendorDubbingCatalogItemBaseFilter.Tokenizer.class)
public abstract class VendorDubbingCatalogItemBaseFilter extends VendorCatalogItemFilter {
	...
	public VendorDubbingCatalogItemBaseFilter() {
		super();
	}

	public VendorDubbingCatalogItemBaseFilter(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaVendorDubbingCatalogItemBaseFilter");
