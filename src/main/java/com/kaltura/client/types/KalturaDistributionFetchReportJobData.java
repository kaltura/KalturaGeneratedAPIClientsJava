...
public class KalturaDistributionFetchReportJobData extends KalturaDistributionJobData {
    ...
    public KalturaDistributionFetchReportJobData(Element node) throws KalturaApiException {
        super(node);
