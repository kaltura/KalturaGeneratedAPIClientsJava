...
@MultiRequestBuilder.Tokenizer(ESearchAbstractUserItem.Tokenizer.class)
public abstract class ESearchAbstractUserItem extends ESearchUserBaseItem {
	...
	public ESearchAbstractUserItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaESearchAbstractUserItem");
