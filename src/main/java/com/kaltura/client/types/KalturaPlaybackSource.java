...
public class KalturaPlaybackSource extends KalturaObjectBase {
    ...
    public ArrayList<KalturaString> protocols;
    public ArrayList<KalturaString> flavors;
    public String url;
    public ArrayList<KalturaDrmEntryPlayingPluginData> drm;
    ...
    public KalturaPlaybackSource(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("deliveryProfileId")) {
                ...
                this.protocols = ParseUtils.parseArray(KalturaString.class, aNode);
                continue;
            } else if (nodeName.equals("flavors")) {
                this.flavors = ParseUtils.parseArray(KalturaString.class, aNode);
                continue;
            } else if (nodeName.equals("url")) {
                this.url = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("drm")) {
                this.drm = ParseUtils.parseArray(KalturaDrmEntryPlayingPluginData.class, aNode);
                continue;
            } 
        }
    }
