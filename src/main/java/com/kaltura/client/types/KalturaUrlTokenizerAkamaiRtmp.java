...
public class KalturaUrlTokenizerAkamaiRtmp extends KalturaUrlTokenizer {
    ...
    public KalturaUrlTokenizerAkamaiRtmp(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("profile")) {
                this.profile = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("type")) {
                this.type = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("aifp")) {
                this.aifp = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("usePrefix")) {
                this.usePrefix = ParseUtils.parseBool(txt);
                continue;
            } 
        }
    }
