...
public class KalturaBaseEntryCloneOptions extends KalturaObjectBase {
    public KalturaNullableBoolean shouldCopyEntitlement;

    public KalturaBaseEntryCloneOptions() {
    }

    public KalturaBaseEntryCloneOptions(Element node) throws KalturaApiException {
        super(node);
    ...
    public KalturaParams toParams() throws KalturaApiException {
        ...
        kparams.add("objectType", "KalturaBaseEntryCloneOptions");
