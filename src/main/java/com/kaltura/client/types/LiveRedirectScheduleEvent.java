...
@MultiRequestBuilder.Tokenizer(LiveRedirectScheduleEvent.Tokenizer.class)
public class LiveRedirectScheduleEvent extends BaseLiveScheduleEvent {
	...
	public LiveRedirectScheduleEvent() {
		super();
	}

	public LiveRedirectScheduleEvent(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaLiveRedirectScheduleEvent");
