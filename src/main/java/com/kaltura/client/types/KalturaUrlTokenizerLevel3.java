...
public class KalturaUrlTokenizerLevel3 extends KalturaUrlTokenizer {
    ...
    public KalturaUrlTokenizerLevel3(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("paramName")) {
                ...
                continue;
            } else if (nodeName.equals("expiryName")) {
                this.expiryName = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("gen")) {
                this.gen = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
