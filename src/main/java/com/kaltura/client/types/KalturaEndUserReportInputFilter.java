...
public class KalturaEndUserReportInputFilter extends KalturaReportInputFilter {
    ...
    public KalturaEndUserReportInputFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("application")) {
                this.application = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("userIds")) {
                this.userIds = ParseUtils.parseString(txt);
                continue;
