...
import com.kaltura.client.enums.KalturaBaseEntryCloneOptions;
import com.kaltura.client.enums.KalturaCloneComponentSelectorType;
...
public class KalturaBaseEntryCloneOptionComponent extends KalturaBaseEntryCloneOptionItem {
    ...
    public KalturaBaseEntryCloneOptionComponent(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("itemType")) {
                this.itemType = KalturaBaseEntryCloneOptions.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("rule")) {
                this.rule = KalturaCloneComponentSelectorType.get(ParseUtils.parseString(txt));
                continue;
            } 
        }
    }
