...
public abstract class KalturaScheduleEventResourceBaseFilter extends KalturaRelatedFilter {
    ...
    public KalturaScheduleEventResourceBaseFilter() {
    }

    public KalturaScheduleEventResourceBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("eventIdEqual")) {
                this.eventIdEqual = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("eventIdIn")) {
                this.eventIdIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("resourceIdEqual")) {
                this.resourceIdEqual = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("resourceIdIn")) {
                this.resourceIdIn = ParseUtils.parseString(txt);
                continue;
