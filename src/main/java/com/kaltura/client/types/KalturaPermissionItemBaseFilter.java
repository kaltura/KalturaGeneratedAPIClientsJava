...
public abstract class KalturaPermissionItemBaseFilter extends KalturaRelatedFilter {
    ...
    public KalturaPermissionItemBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.typeEqual = KalturaPermissionItemType.get(ParseUtils.parseString(txt));
                continue;
