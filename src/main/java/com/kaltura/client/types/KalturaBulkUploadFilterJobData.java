...
public class KalturaBulkUploadFilterJobData extends KalturaBulkUploadJobData {
    ...
    public KalturaBulkUploadFilterJobData(Element node) throws KalturaApiException {
        super(node);
