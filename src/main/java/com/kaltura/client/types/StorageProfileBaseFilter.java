...
@MultiRequestBuilder.Tokenizer(StorageProfileBaseFilter.Tokenizer.class)
public abstract class StorageProfileBaseFilter extends Filter {
	...
	public void protocolEqual(String multirequestToken){
		setToken("protocolEqual", multirequestToken);
	}
	...
	public void protocolIn(String multirequestToken){
		setToken("protocolIn", multirequestToken);
	}
