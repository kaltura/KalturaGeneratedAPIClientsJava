...
public class KalturaDrmEntryContextPluginData extends KalturaPluginData {
    ...
    public KalturaDrmEntryContextPluginData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("flavorData")) {
                this.flavorData = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
