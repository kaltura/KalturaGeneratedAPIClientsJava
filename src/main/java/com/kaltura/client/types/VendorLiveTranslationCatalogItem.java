...
@MultiRequestBuilder.Tokenizer(VendorLiveTranslationCatalogItem.Tokenizer.class)
public class VendorLiveTranslationCatalogItem extends VendorLiveCatalogItem {
	...
	public VendorLiveTranslationCatalogItem() {
		super();
	}

	public VendorLiveTranslationCatalogItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaVendorLiveTranslationCatalogItem");
