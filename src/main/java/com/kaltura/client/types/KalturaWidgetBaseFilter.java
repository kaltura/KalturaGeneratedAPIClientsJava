    ...
    public KalturaWidgetBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.sourceWidgetIdEqual = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("rootWidgetIdEqual")) {
                this.rootWidgetIdEqual = ParseUtils.parseString(txt);
                continue;
                ...
                this.uiConfIdEqual = ParseUtils.parseInt(txt);
                continue;
                ...
                this.partnerDataLike = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
