...
public class KalturaIdeticDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public KalturaIdeticDistributionProfile(Element node) throws KalturaApiException {
        super(node);
