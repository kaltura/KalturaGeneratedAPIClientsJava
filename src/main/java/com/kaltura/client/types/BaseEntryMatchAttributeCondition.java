...
@MultiRequestBuilder.Tokenizer(BaseEntryMatchAttributeCondition.Tokenizer.class)
public class BaseEntryMatchAttributeCondition extends SearchMatchAttributeCondition {
	...
	public void setAttribute(BaseEntryMatchAttribute attribute){
	...
	public BaseEntryMatchAttributeCondition(JsonObject jsonObject) throws APIException {
		...
		// set members values:
		attribute = BaseEntryMatchAttribute.get(GsonParser.parseString(jsonObject.get("attribute")));
