...
public class KalturaDeliveryProfileCondition extends KalturaCondition {
    ...
    public KalturaDeliveryProfileCondition(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("deliveryProfileIds")) {
                this.deliveryProfileIds = ParseUtils.parseArray(KalturaIntegerValue.class, aNode);
                continue;
            } 
        }
    }
