...
public class KalturaSiteRestriction extends KalturaBaseRestriction {
    ...
    public KalturaSiteRestriction(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("siteRestrictionType")) {
                this.siteRestrictionType = KalturaSiteRestrictionType.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("siteList")) {
                this.siteList = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
