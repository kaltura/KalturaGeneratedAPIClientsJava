...
@MultiRequestBuilder.Tokenizer(MatchMetadataCondition.Tokenizer.class)
public class MatchMetadataCondition extends MatchCondition {
	...
	public MatchMetadataCondition(JsonObject jsonObject) throws APIException {
		super(jsonObject);
