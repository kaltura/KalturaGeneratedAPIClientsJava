...
public abstract class KalturaBeaconBaseFilter extends KalturaFilter {
    ...
    public KalturaBeaconBaseFilter() {
    }

    public KalturaBeaconBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("updatedAtGreaterThanOrEqual")) {
