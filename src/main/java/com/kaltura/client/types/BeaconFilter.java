...
@MultiRequestBuilder.Tokenizer(BeaconFilter.Tokenizer.class)
public class BeaconFilter extends BeaconBaseFilter {
	
	public interface Tokenizer extends BeaconBaseFilter.Tokenizer {
	...
	public BeaconFilter(JsonObject jsonObject) throws APIException {
		super(jsonObject);
