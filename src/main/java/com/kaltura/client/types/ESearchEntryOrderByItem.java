...
@MultiRequestBuilder.Tokenizer(ESearchEntryOrderByItem.Tokenizer.class)
public class ESearchEntryOrderByItem extends ESearchOrderByItem {
	...
	public void setSortField(ESearchEntryOrderByFieldName sortField){
	...
	public ESearchEntryOrderByItem(JsonObject jsonObject) throws APIException {
		...
		// set members values:
		sortField = ESearchEntryOrderByFieldName.get(GsonParser.parseString(jsonObject.get("sortField")));

	}

	public Params toParams() {
		Params kparams = super.toParams();
		kparams.add("objectType", "KalturaESearchEntryOrderByItem");
