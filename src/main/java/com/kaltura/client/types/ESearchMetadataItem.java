...
@MultiRequestBuilder.Tokenizer(ESearchMetadataItem.Tokenizer.class)
public class ESearchMetadataItem extends ESearchItem {
	...
	public ESearchMetadataItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);
