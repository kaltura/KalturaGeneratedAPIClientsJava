...
@MultiRequestBuilder.Tokenizer(GeoDistanceCondition.Tokenizer.class)
public class GeoDistanceCondition extends MatchCondition {
	...
	public GeoDistanceCondition() {
		super();
	}

	public GeoDistanceCondition(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaGeoDistanceCondition");
