...
@MultiRequestBuilder.Tokenizer(ESearchAbstractCategoryItem.Tokenizer.class)
public abstract class ESearchAbstractCategoryItem extends ESearchCategoryBaseItem {
	...
	public ESearchAbstractCategoryItem() {
		super();
	}

	public ESearchAbstractCategoryItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaESearchAbstractCategoryItem");
