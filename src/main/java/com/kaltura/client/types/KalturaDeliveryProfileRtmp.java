...
public class KalturaDeliveryProfileRtmp extends KalturaDeliveryProfile {
    ...
    public KalturaDeliveryProfileRtmp(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("enforceRtmpe")) {
                this.enforceRtmpe = ParseUtils.parseBool(txt);
                continue;
            } else if (nodeName.equals("prefix")) {
                this.prefix = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
