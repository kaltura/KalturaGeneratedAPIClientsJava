...
public class KalturaEmailNotificationStaticRecipientJobData extends KalturaEmailNotificationRecipientJobData {
    ...
    public KalturaEmailNotificationStaticRecipientJobData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("emailRecipients")) {
                this.emailRecipients = ParseUtils.parseArray(KalturaKeyValue.class, aNode);
                continue;
            } 
        }
    }
