...
public abstract class KalturaScheduledTaskProfileBaseFilter extends KalturaFilter {
    ...
    public KalturaScheduledTaskProfileStatus statusEqual;
    ...
    public int lastExecutionStartedAtGreaterThanOrEqual = Integer.MIN_VALUE;
    public int lastExecutionStartedAtLessThanOrEqual = Integer.MIN_VALUE;

    public KalturaScheduledTaskProfileBaseFilter() {
    }

    public KalturaScheduledTaskProfileBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = KalturaScheduledTaskProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
                ...
                continue;
            } else if (nodeName.equals("lastExecutionStartedAtGreaterThanOrEqual")) {
                this.lastExecutionStartedAtGreaterThanOrEqual = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("lastExecutionStartedAtLessThanOrEqual")) {
                this.lastExecutionStartedAtLessThanOrEqual = ParseUtils.parseInt(txt);
                continue;
            } 
        }
    }
