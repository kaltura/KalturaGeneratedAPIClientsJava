...
@MultiRequestBuilder.Tokenizer(AssetTypeCondition.Tokenizer.class)
public class AssetTypeCondition extends Condition {
	...
	public AssetTypeCondition(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaAssetTypeCondition");
