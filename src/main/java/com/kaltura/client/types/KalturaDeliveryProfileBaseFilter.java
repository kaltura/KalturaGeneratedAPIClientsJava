...
public abstract class KalturaDeliveryProfileBaseFilter extends KalturaFilter {
    ...
    public KalturaPlaybackProtocol streamerTypeEqual;
    public KalturaDeliveryStatus statusEqual;
    public String statusIn;

    public KalturaDeliveryProfileBaseFilter() {
    }

    public KalturaDeliveryProfileBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                continue;
            } else if (nodeName.equals("streamerTypeEqual")) {
                this.streamerTypeEqual = KalturaPlaybackProtocol.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("statusEqual")) {
                this.statusEqual = KalturaDeliveryStatus.get(ParseUtils.parseInt(txt));
                continue;
