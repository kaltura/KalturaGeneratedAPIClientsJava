...
public class KalturaEmailNotificationUserRecipientProvider extends KalturaEmailNotificationRecipientProvider {
    ...
    public KalturaEmailNotificationUserRecipientProvider() {
    }

    public KalturaEmailNotificationUserRecipientProvider(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("filter")) {
                this.filter = ParseUtils.parseObject(KalturaUserFilter.class, aNode);
                continue;
            } 
        }
    }
