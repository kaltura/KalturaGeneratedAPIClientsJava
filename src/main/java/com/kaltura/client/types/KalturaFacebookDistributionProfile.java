...
public class KalturaFacebookDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public int reRequestPermissions = Integer.MIN_VALUE;

    public KalturaFacebookDistributionProfile() {
    }

    public KalturaFacebookDistributionProfile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("apiAuthorizeUrl")) {
                this.apiAuthorizeUrl = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("pageId")) {
                this.pageId = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("pageAccessToken")) {
                this.pageAccessToken = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("userAccessToken")) {
                this.userAccessToken = ParseUtils.parseString(txt);
                continue;
                ...
                continue;
            } else if (nodeName.equals("reRequestPermissions")) {
                this.reRequestPermissions = ParseUtils.parseInt(txt);
                continue;
            } 
        }
    }
