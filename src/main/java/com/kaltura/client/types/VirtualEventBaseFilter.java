...
@MultiRequestBuilder.Tokenizer(VirtualEventBaseFilter.Tokenizer.class)
public abstract class VirtualEventBaseFilter extends Filter {
	...
	private VirtualEventStatus statusEqual;
	...
	// statusEqual:
	public VirtualEventStatus getStatusEqual(){
		return this.statusEqual;
	}
	public void setStatusEqual(VirtualEventStatus statusEqual){
	...
	public VirtualEventBaseFilter() {
		super();
	}

	public VirtualEventBaseFilter(JsonObject jsonObject) throws APIException {
		super(jsonObject);
		...
		statusEqual = VirtualEventStatus.get(GsonParser.parseInt(jsonObject.get("statusEqual")));
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaVirtualEventBaseFilter");
