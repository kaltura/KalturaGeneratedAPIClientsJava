...
@MultiRequestBuilder.Tokenizer(ImageFlavorParamsOutput.Tokenizer.class)
public class ImageFlavorParamsOutput extends FlavorParamsOutput {
	...
	public ImageFlavorParamsOutput(JsonObject jsonObject) throws APIException {
		super(jsonObject);
