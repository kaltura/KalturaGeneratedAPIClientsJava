...
public class KalturaEmailNotificationCategoryRecipientProvider extends KalturaEmailNotificationRecipientProvider {
    ...
    public KalturaEmailNotificationCategoryRecipientProvider(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("categoryId")) {
                this.categoryId = ParseUtils.parseObject(KalturaStringValue.class, aNode);
                continue;
            } else if (nodeName.equals("categoryUserFilter")) {
                this.categoryUserFilter = ParseUtils.parseObject(KalturaCategoryUserProviderFilter.class, aNode);
                continue;
            } 
        }
    }
