...
@MultiRequestBuilder.Tokenizer(LiveStreamAdminEntryMatchAttributeCondition.Tokenizer.class)
public class LiveStreamAdminEntryMatchAttributeCondition extends SearchMatchAttributeCondition {
	...
	public void setAttribute(LiveStreamAdminEntryMatchAttribute attribute){
	...
	public LiveStreamAdminEntryMatchAttributeCondition(JsonObject jsonObject) throws APIException {
		...
		// set members values:
		attribute = LiveStreamAdminEntryMatchAttribute.get(GsonParser.parseString(jsonObject.get("attribute")));
