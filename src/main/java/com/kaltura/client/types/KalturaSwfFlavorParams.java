...
public class KalturaSwfFlavorParams extends KalturaFlavorParams {
    public int flashVersion = Integer.MIN_VALUE;
    public boolean poly2Bitmap;

    public KalturaSwfFlavorParams() {
    }

    public KalturaSwfFlavorParams(Element node) throws KalturaApiException {
        super(node);
