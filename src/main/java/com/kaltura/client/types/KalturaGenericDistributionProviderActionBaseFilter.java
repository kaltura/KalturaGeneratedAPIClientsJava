    ...
    public KalturaGenericDistributionProviderActionBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.genericDistributionProviderIdEqual = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("genericDistributionProviderIdIn")) {
                this.genericDistributionProviderIdIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("actionEqual")) {
                this.actionEqual = KalturaDistributionAction.get(ParseUtils.parseInt(txt));
                continue;
