...
@MultiRequestBuilder.Tokenizer(SystemPartnerUsageItem.Tokenizer.class)
public class SystemPartnerUsageItem extends ObjectBase {
	...
	public interface Tokenizer extends ObjectBase.Tokenizer {
		...
		String peakStorage();
		String avgStorage();
		String combinedBandwidthStorage();
	...
	public void combinedBandwidthStorage(String multirequestToken){
		setToken("combinedBandwidthStorage", multirequestToken);
	}
