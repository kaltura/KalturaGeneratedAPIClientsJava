...
import com.kaltura.client.enums.KalturaCategoryEntryAdvancedOrderBy;
...
public class KalturaCategoryEntryAdvancedFilter extends KalturaSearchItem {
    ...
    public KalturaCategoryEntryAdvancedFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("categoriesMatchOr")) {
                ...
                this.orderBy = KalturaCategoryEntryAdvancedOrderBy.get(ParseUtils.parseString(txt));
                continue;
