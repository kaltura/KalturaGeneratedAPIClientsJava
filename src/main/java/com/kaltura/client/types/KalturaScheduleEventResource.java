...
public class KalturaScheduleEventResource extends KalturaObjectBase {
    ...
    public KalturaScheduleEventResource(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("eventId")) {
                this.eventId = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("resourceId")) {
                this.resourceId = ParseUtils.parseInt(txt);
                continue;
