...
public class KalturaFacebookCaptionDistributionInfo extends KalturaObjectBase {
    ...
    public KalturaFacebookCaptionDistributionInfo(Element node) throws KalturaApiException {
        super(node);
