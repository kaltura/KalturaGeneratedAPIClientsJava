...
public class KalturaAssetPropertiesCompareCondition extends KalturaCondition {
    ...
    public KalturaAssetPropertiesCompareCondition(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("properties")) {
                this.properties = ParseUtils.parseArray(KalturaKeyValue.class, aNode);
                continue;
            } 
        }
    }
