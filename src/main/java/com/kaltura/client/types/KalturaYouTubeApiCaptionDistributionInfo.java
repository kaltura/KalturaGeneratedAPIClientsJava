...
import com.kaltura.client.enums.KalturaYouTubeApiDistributionCaptionAction;
...
public class KalturaYouTubeApiCaptionDistributionInfo extends KalturaObjectBase {
    ...
    public KalturaYouTubeApiCaptionDistributionInfo(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("language")) {
                ...
                this.action = KalturaYouTubeApiDistributionCaptionAction.get(ParseUtils.parseInt(txt));
                continue;
