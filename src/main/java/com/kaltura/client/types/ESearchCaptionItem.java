...
public class ESearchCaptionItem extends ESearchItem {
	...
	public void setFieldName(ESearchCaptionFieldName fieldName){
	...
	public ESearchCaptionItem(JsonObject jsonObject) throws APIException {
		super(jsonObject);

		if(jsonObject == null) return;

		// set members values:
		fieldName = ESearchCaptionFieldName.get(GsonParser.parseString(jsonObject.get("fieldName")));

	}

	public Params toParams() {
		Params kparams = super.toParams();
		kparams.add("objectType", "KalturaESearchCaptionItem");
