...
public class PushToNewsDistributionProfile extends ConfigurableDistributionProfile {
	...
	public void setNamedItem(String namedItem){
		this.namedItem = namedItem;
	}

	public void namedItem(String multirequestToken){
		setToken("namedItem", multirequestToken);
	}
	...
	public PushToNewsDistributionProfile(JsonObject jsonObject) throws APIException {
		...
		namedItem = GsonParser.parseString(jsonObject.get("namedItem"));
	...
	public Params toParams() {
		...
		kparams.add("namedItem", this.namedItem);
