 ...
 */
public enum KalturaLiveStreamAdminEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveStreamAdminEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaLiveStreamAdminEntryCompareAttribute get(String hashCode) {
