 ...
 */
public enum KalturaLiveChannelMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveChannelMatchAttribute(String hashCode) {
    ...
    public static KalturaLiveChannelMatchAttribute get(String hashCode) {
