 ...
 */
public enum KalturaLiveChannelCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveChannelCompareAttribute(String hashCode) {
    ...
    public static KalturaLiveChannelCompareAttribute get(String hashCode) {
