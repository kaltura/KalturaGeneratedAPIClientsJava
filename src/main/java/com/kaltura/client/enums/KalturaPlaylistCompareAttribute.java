 ...
 */
public enum KalturaPlaylistCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaPlaylistCompareAttribute(String hashCode) {
    ...
    public static KalturaPlaylistCompareAttribute get(String hashCode) {
