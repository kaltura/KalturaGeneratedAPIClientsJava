 ...
 */
public enum KalturaDataEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaDataEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaDataEntryCompareAttribute get(String hashCode) {
