 ...
 */
public enum KalturaLiveStreamEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveStreamEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaLiveStreamEntryMatchAttribute get(String hashCode) {
