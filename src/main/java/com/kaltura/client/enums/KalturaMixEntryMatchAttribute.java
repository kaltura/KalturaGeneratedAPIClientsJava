 ...
 */
public enum KalturaMixEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaMixEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaMixEntryMatchAttribute get(String hashCode) {
