 ...
 */
public enum KalturaDataEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaDataEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaDataEntryMatchAttribute get(String hashCode) {
