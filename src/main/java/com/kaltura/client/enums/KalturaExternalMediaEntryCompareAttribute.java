 ...
 */
public enum KalturaExternalMediaEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaExternalMediaEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaExternalMediaEntryCompareAttribute get(String hashCode) {
