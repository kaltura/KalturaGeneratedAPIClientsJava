 ...
 */
public enum KalturaLiveStreamAdminEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveStreamAdminEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaLiveStreamAdminEntryMatchAttribute get(String hashCode) {
