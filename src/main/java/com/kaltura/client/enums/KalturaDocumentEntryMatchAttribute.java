 ...
 */
public enum KalturaDocumentEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaDocumentEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaDocumentEntryMatchAttribute get(String hashCode) {
