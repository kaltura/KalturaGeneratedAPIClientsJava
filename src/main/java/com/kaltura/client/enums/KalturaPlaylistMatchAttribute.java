 ...
 */
public enum KalturaPlaylistMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaPlaylistMatchAttribute(String hashCode) {
    ...
    public static KalturaPlaylistMatchAttribute get(String hashCode) {
