 ...
 */
public enum KalturaDocumentEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaDocumentEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaDocumentEntryCompareAttribute get(String hashCode) {
