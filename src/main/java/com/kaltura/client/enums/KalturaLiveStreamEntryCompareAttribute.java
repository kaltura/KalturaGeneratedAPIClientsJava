 ...
 */
public enum KalturaLiveStreamEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveStreamEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaLiveStreamEntryCompareAttribute get(String hashCode) {
