 ...
 */
public enum KalturaMediaEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaMediaEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaMediaEntryMatchAttribute get(String hashCode) {
