 ...
 */
public enum KalturaBaseEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaBaseEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaBaseEntryCompareAttribute get(String hashCode) {
