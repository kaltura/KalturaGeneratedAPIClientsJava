 ...
 */
public enum KalturaPlayableEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaPlayableEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaPlayableEntryMatchAttribute get(String hashCode) {
