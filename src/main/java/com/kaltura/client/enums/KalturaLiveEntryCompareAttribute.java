 ...
 */
public enum KalturaLiveEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaLiveEntryCompareAttribute get(String hashCode) {
