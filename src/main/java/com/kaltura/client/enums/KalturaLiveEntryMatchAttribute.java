 ...
 */
public enum KalturaLiveEntryMatchAttribute implements KalturaEnumAsString {
    ...
    KalturaLiveEntryMatchAttribute(String hashCode) {
    ...
    public static KalturaLiveEntryMatchAttribute get(String hashCode) {
