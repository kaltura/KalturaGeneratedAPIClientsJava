 ...
 */
public enum KalturaMixEntryCompareAttribute implements KalturaEnumAsString {
    ...
    KalturaMixEntryCompareAttribute(String hashCode) {
    ...
    public static KalturaMixEntryCompareAttribute get(String hashCode) {
