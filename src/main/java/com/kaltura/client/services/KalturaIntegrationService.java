...
public class KalturaIntegrationService extends KalturaServiceBase {
    ...
    public int dispatch(KalturaIntegrationJobData data, KalturaBatchJobObjectType objectType, String objectId) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("integration_integration", "dispatch", kparams);
    ...
    public void notify(int id) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("id", id);
        this.kalturaClient.queueServiceCall("integration_integration", "notify", kparams);
        if (this.kalturaClient.isMultiRequest())
            return ;
