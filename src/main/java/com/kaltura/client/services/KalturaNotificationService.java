...
public class KalturaNotificationService extends KalturaServiceBase {
    ...
    public KalturaClientNotification getClientNotification(String entryId, KalturaNotificationType type) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("notification", "getClientNotification", kparams, KalturaClientNotification.class);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaClientNotification.class, resultXmlElement);
    }
}
