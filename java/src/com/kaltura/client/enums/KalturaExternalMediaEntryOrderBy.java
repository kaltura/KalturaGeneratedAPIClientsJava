 ...
 */
public enum KalturaExternalMediaEntryOrderBy implements KalturaEnumAsString {
    ...
    KalturaExternalMediaEntryOrderBy(String hashCode) {
    ...
    public static KalturaExternalMediaEntryOrderBy get(String hashCode) {
