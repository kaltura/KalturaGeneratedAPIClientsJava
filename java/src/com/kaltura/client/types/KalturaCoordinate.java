...
public class KalturaCoordinate extends KalturaObjectBase {
    ...
    public KalturaCoordinate(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("latitude")) {
                this.latitude = ParseUtils.parseDouble(txt);
                continue;
            } else if (nodeName.equals("longitude")) {
                this.longitude = ParseUtils.parseDouble(txt);
                continue;
