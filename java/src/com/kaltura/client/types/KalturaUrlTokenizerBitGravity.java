...
public class KalturaUrlTokenizerBitGravity extends KalturaUrlTokenizer {
    ...
    public KalturaUrlTokenizerBitGravity(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("hashPatternRegex")) {
                this.hashPatternRegex = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
