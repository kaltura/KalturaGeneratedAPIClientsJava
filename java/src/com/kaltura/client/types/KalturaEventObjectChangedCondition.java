...
public class KalturaEventObjectChangedCondition extends KalturaCondition {
    ...
    public KalturaEventObjectChangedCondition(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("modifiedColumns")) {
                this.modifiedColumns = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
