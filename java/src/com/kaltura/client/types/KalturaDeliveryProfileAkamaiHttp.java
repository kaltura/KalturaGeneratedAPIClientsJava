...
public class KalturaDeliveryProfileAkamaiHttp extends KalturaDeliveryProfile {
    ...
    public KalturaDeliveryProfileAkamaiHttp(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("useIntelliseek")) {
                this.useIntelliseek = ParseUtils.parseBool(txt);
                continue;
            } 
        }
    }
