...
public class KalturaBulkUploadResultCategoryEntry extends KalturaBulkUploadResult {
    ...
    public KalturaBulkUploadResultCategoryEntry(Element node) throws KalturaApiException {
        super(node);
