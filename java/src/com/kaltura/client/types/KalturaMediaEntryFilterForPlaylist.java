...
public class KalturaMediaEntryFilterForPlaylist extends KalturaMediaEntryFilter {
    public int limit = Integer.MIN_VALUE;

    public KalturaMediaEntryFilterForPlaylist() {
    }

    public KalturaMediaEntryFilterForPlaylist(Element node) throws KalturaApiException {
        super(node);
