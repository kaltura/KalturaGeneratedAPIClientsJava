...
public abstract class KalturaFlavorParamsBaseFilter extends KalturaAssetParamsFilter {
    public KalturaContainerFormat formatEqual;

    public KalturaFlavorParamsBaseFilter() {
    }

    public KalturaFlavorParamsBaseFilter(Element node) throws KalturaApiException {
        super(node);
