...
public class KalturaLiveStreamPushPublishConfiguration extends KalturaObjectBase {
    ...
    public KalturaLiveStreamPushPublishConfiguration(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("publishUrl")) {
                ...
                this.backupPublishUrl = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("port")) {
                this.port = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
